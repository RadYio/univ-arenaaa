...
carte_t * creer_carte(char * nom,char * nom_collec ,int hp , int nb_degats , type_t type_attaque , type_t type_vulnerable, int id_image){
  carte_t * carte;
...
void init_cartes(carte_t * tab_cartes_total[]){
    tab_cartes_total[0] = creer_carte("Allan maître des l'esprit","Allan", 10, 4 , Psy,Poison,0);
    tab_cartes_total[1] = creer_carte("Charly maître du ratio","Charly", 10, 4 , Psy,Poison,1);
    tab_cartes_total[2] = creer_carte("Jonathan maître du temps","Jonathan", 10, 4 , Physique,Psy,2);
    tab_cartes_total[3] = creer_carte("Léo maître de la bagarre","Léo", 10, 4 , Physique,Psy,3);
    tab_cartes_total[4] = creer_carte("Alexis maître du sel","Alexis", 10, 4 , Poison,Physique,4);
    tab_cartes_total[5] = creer_carte("Arthur maître du silence","Arthur", 10, 4 , Poison,Physique,5);
    tab_cartes_total[6] = creer_carte("Chevalier","Chevalier1", 5, 3 , Physique,Psy,6);
    tab_cartes_total[7] = creer_carte("Chevalier","Chevalier", 5, 3 , Physique,Psy,7);
    tab_cartes_total[8] = creer_carte("Mage","Mage", 3, 5 , Psy,Poison,8);
    tab_cartes_total[9] = creer_carte("Mage","Mage", 3, 5 , Psy,Poison,9);
    tab_cartes_total[10] = creer_carte("Voleur","Voleur", 4, 4 , Poison,Physique,10);
    tab_cartes_total[11] = creer_carte("Voleur","Voleur", 4, 4 , Poison,Physique,11);
    tab_cartes_total[12] = creer_carte("Roi Antoine Laurent","A.Laurent", 10, 10 , Psy,Psy,12); //a modifier
}
