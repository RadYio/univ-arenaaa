...
void init_cartes(carte_t tab_cartes_total[]){
    ...
    tab_cartes_total[12] = creer_carte2("Arthur maître du silence","Arthur", "img/Carte_Leo.png", 10, 4, Poison, Physique, 12);
    ...
    tab_cartes_total[5] = creer_carte2("Roi Antoine Laurent","A.Laurent", "img/img_cartes/Antoine-Laurent.png", 2, 99, Psy, Psy, 5);
}
